 ...
 */
@Entity
@Table(name = "assigncourse")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Assigncourse.findAll", query = "SELECT a FROM Assigncourse a")
    , @NamedQuery(name = "Assigncourse.findById", query = "SELECT a FROM Assigncourse a WHERE a.id = :id")})
public class Assigncourse implements Serializable {
    ...
    public Assigncourse(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Assigncourse)) {
            return false;
        }
        Assigncourse other = (Assigncourse) object;
    ...
    public String toString() {
        return "Entities.Courses.Assigncourse[ id=" + id + " ]";
    }
